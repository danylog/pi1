...
public:
     ...
     *
     * \return std::string: gibt den Titel des Mediums zur�ck
     */

    bool istAusgeliehen() const { return status; }
...
/*!
 * @brief Ausgabeoperator fuer die Klasse Medium
 *
 * \param std::ostream& out: Ausgabestream, auf dem die Ausgabe erfolgt
 * \param const Medium& medium: Medium, dessen Informationen ausgegeben werden sollen
 *
 * \return std::ostream&: gibt den Ausgabestream zurueck
 */
